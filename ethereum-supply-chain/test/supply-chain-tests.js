...
contract("ProductManagement", accounts => {
    ...
    it("should create a computer using 6 parts and store it", async () => {
        //First, create the computer parts
        ...
        //Then create the computer itself from the parts. Each part must be given as a hash that contains the wallet address and the part info.
        const serial_prod = "12345678"
        const product_type = "computer"

        result = await contract.buildProduct(serial_prod, product_type, creation_date, part_array, { from: accounts[0] })
        //Then check the computer is in storage. Again, the hash should be the one below
        ...
        //Get parts and compare to the ones used when building the computer
